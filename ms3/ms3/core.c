...
// Validation for inputting a integer
int inputInt(void)
{
    char newLine = 'x';
    int input = 'x';
...
// Check if the input char can be found in the received string
...
// Validation for inputting a string that is within the constrained size
...
// Validation for inputting a phone number that is within the constrained size
void inputPhoneValidation(char* receive, int min, int max)
{
    int size = 0;
    int done = 0;
    char input[1000 + 1] = { "\0" };
...
// UTILITY FUNCTIONS
//////////////////////////////////////
// Validation for inputting a positive integer
...
// Validation for inputting a integer that is within boundary
...
// Validation for inputting a phone-number (string) that match with the provided phone number
