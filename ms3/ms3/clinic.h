...
#define FMT_ALL 1
#define FMT_SPECIFIC 0

// Date setting
#define MAX_YEAR 2027
...
#define MAX_HOUR 14
#define MIN_HOUR 10
#define MINUTE_INTERVAL_0 0
#define MINUTE_INTERVAL_30 30

// Display for searching Patient number function
#define FMT_Patient 1
#define FMT_Appointment 2
...
struct Phone
{
    char description[PHONE_DESC_LEN + 1]; // "CELL", "HOME", "WORK", "TBD"
